...
const neetSubCategories = [
    {
        name: 'NEET UG',
        description: 'Undergraduate medical entrance examination for MBBS/BDS courses.',
    },
    {
        name: 'NEET PG',
        description: 'Postgraduate medical entrance examination for MD/MS courses.',
    },
];
    ...
    return (
        <div className="flex min-h-screen w-full flex-col">
            ...
            <main className="flex-1 p-4 md:p-8">
                <div className="mb-8">
                    <h1 className="text-4xl font-bold font-headline tracking-tight">NEET (Medical)</h1>
                ...
                <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
                    ...
                    <Link href={`/exams/NEET/Previous Year Paper`}>
                        <Card className="flex flex-col justify-between h-full hover:bg-card/70 transition-all duration-300 shadow-glow-br hover:shadow-glow-tl">
                            <CardHeader>
                                <div className="flex items-center gap-4">
