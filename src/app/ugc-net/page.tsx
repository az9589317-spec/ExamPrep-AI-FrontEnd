        ...
        <div className="flex min-h-screen w-full flex-col">
            ...
            <main className="flex-1 p-4 md:p-8">
                ...
                <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
                        ...
                        <Card className="flex flex-col justify-between h-full hover:bg-card/70 transition-all duration-300 shadow-glow-br hover:shadow-glow-tl">
                            <CardHeader>
                                <div className="flex items-center gap-4">
                                    ...
                                    <CardTitle className="font-headline">UGC NET Papers</CardTitle>
                                </div>
                                <CardDescription className="pt-2">
                                    Practice with mock tests for UGC NET exams.
                                </CardDescription>
                            </CardHeader>
                            <CardContent>
                    ...
                    <Link href={`/exams/Previous Year Paper/UGC NET`}>
                        <Card className="flex flex-col justify-between h-full hover:bg-card/70 transition-all duration-300 shadow-glow-br hover:shadow-glow-tl">
                            <CardHeader>
                                <div className="flex items-center gap-4">
