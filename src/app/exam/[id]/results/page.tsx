          ...
          <Card>
            ...
            <CardContent>
              <div className="grid grid-cols-2 gap-6 text-center md:grid-cols-4">
                <div className="flex flex-col items-center justify-center rounded-lg bg-accent/30 p-4">
              ...
              <div className="mt-6 space-y-4">
                <div className="flex items-center justify-between">
                    <span className="flex items-center gap-2 text-sm text-green-600"><CheckCircle className="h-4 w-4" /> Correct</span>
                ...
                <div className="flex items-center justify-between">
                    <span className="flex items-center gap-2 text-sm text-red-600"><XCircle className="h-4 w-4" /> Incorrect</span>
                      ...
                      <AccordionContent className="space-y-6 p-2">
                        ...
                        <div className="space-y-2">
                          {question.options.map((option, optionIndex) => {
                            ...
                            return (
                              <div key={optionIndex} className={`flex items-center gap-3 rounded-lg p-3 ${optionClass}`}>
                                {icon}
